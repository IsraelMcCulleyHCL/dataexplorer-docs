...
1. On the **Navigator** screen, expand the **Samples** database, select **StormEvents** then **Edit**. Note: the button may say "Transform Data" instead of "Edit". If so, click Transform Data.
